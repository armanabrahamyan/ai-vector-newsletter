...
description: Pre-PR checklist enforcing PLAN.md §0 — design before code, evals before features, determinism in code and judgment in the LLM, subscribe don't scrape. Invoke before opening any PR that touches src/, config/, templates/, evals/, or docs/internal/DESIGN.md.
---
...
- [ ] `docs/internal/DESIGN.md` reflects the new shape (owner: Architect; if you're not
